...
const TREE_TYPES = [
    "ต้นจามจุรี", "ต้นพฤกษ์", "ต้นนนทรี", "ต้นประดู่", "ต้นมะฮอกกานี", "ต้นกระพี้จั่น", "ต้นอินทนิล", "ต้นตะแบก", "ต้นเสลา", "ต้นสะเดา", "ต้นเหลืองปรีดียาธร", "ต้นปีบ", "ต้นกระถินณรงค์", "ต้นชมพูพันธ์ทิพย์", "ต้นพิกุล", "ต้นขี้เหล็ก", "ต้นพะยูง", "ต้นสาเก", "ต้นกระทิง", "ต้นโศก", "ต้นจิกทะเล", "ต้นจิกสวน", "ต้นชะแมบทอง", "ต้นหางนกยูง", "ต้นทองอุไร", "ต้นไทร", "ต้นหว้า", "ต้นมะขาม", "ต้นตะเคียน", "ต้นมะกอกน้ำ", "ต้นตีนเป็ด", "ต้นพญาสัตบรรณ", "ต้นพะยอม", "ต้นทองกวาว"
];
